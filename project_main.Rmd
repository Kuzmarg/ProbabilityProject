...
```
Let`s now see how popularitн of different genres changed over years
(xlab deopicts the year when there was the biggest number of films of such category produced)
```{r}
