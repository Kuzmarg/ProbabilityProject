...
plot(Years, MaleAges, col = "blue", main = "Mean Age of Leading Male Actor over Years")
points(Years, FemaleAges, col = "purple", main = "Mean Age of Leading Female Actor over Years")
